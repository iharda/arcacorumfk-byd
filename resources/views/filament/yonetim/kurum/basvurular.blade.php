{{-- Kurum detayı · Başvuru geçmişi sekmesi. --}}
<x-filament::section>
    @if ($basvurular->isEmpty())
        <p style="font-size:.85rem; opacity:.7;">Bu kuruma ait başvuru yok.</p>
    @else
            ...
            @foreach ($basvurular as $b)
                <div style="display:flex; gap:.7rem; flex-wrap:wrap; align-items:baseline; font-size:.88rem;
                    ...
                    <span style="margin-left:auto;">
                        <x-filament::badge :color="$b->durumRengi()">{{ $b->durumEtiketi() }}</x-filament::badge>
                    </span>
