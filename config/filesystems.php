...
return [
    ...
    */
    ...
    'disks' => [
        ...
        /*
         * BYS evrak deposu -- Plan v1.0 md.11.
         ...
         * Musterinin sunucusuna tasinirken .env'deki BYS_EVRAK_DISK'i 'evrak_r2'
         * yapmak yeterli; kod degismez (tasinabilirlik sarti).
         */
        'evrak' => [
            'driver' => 'local',
            'root' => storage_path('app/evrak'),
            'serve' => false,
            'throw' => true,
        ],
