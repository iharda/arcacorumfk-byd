...
await p.goto('file:///tmp/byd-kart-onizleme.html',{waitUntil:'networkidle0'});
await p.screenshot({path:'/root/byd-kart-taslak.png'});
await p.pdf({path:'/root/byd-kart-taslak.pdf',width:'90mm',height:'130mm',printBackground:true,margin:{top:0,right:0,bottom:0,left:0}});
await b.close();
