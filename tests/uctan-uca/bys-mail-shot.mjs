...
await p.goto('file:///tmp/bys-mail-onizleme.html',{waitUntil:'networkidle0'});
await p.screenshot({path:'/root/bys-mail-ornek.png',fullPage:true});
await b.close();
console.log('e-posta görüntüsü: /root/bys-mail-ornek.png');
